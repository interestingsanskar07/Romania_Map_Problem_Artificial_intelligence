...
def printoutput(start, end, path, distance, expandedlist):
    ...
    print("total node in path: " + str(len(expandedlist)))
    print("final path: " + str(finalpath))
    print("total nodes in  final path: " + str(len(finalpath)))
